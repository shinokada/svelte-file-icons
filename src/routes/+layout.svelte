...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-file-icons',
        width: 1200,
        height: 630,
        alt: 'Svelte File Icons'
      }
    ],
...
<Footer footerType="logo" class="dark:bg-slate-900">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    >
      ...
      <FooterLink href="https://github.com/shinokada/svelte-file-icons/blob/main/LICENSE"
