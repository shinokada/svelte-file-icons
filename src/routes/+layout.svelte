...
<MetaTags
  title="Svelte File Icons"
  description="File Icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-file-icons.vercel.app/',
    title: "Svelte File Icons",
    description: "File Icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-file-icons', width: 1200, height: 630, alt: "Svelte File Icons" }],
    site_name: 'Svelte File Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte File Icons",
    description: "File Icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-file-icons',
    imageAlt: "Svelte File Icons"
  }} />
  
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-900">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-900 ">
    ...
    <NavLi href="https://github.com/shinokada/svelte-file-icons">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-slate-900">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
    href="https://svelte-file-icons.vercel.app/"
  ...
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    ...
    <FooterLink href="https://github.com/shinokada/svelte-file-icons/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-file-icons/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
